"""
测试新版EnhancedMatcher类的standardize_texts方法
"""
...
# 导入必要的模块
from spotify_playlist_importer.utils.enhanced_matcher_new import EnhancedMatcher
...
def test_standardize_texts():
    ...
    print("=== 测试 EnhancedMatcher.standardize_texts 方法 ===")
...
def test_get_enhanced_match():
    ...
    # 导入函数
    from spotify_playlist_importer.utils.enhanced_matcher_new import get_enhanced_match
